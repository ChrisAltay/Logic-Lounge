...
<body class="privmes">
    ...
    <div class="privmeshead">

    <div class="privmes-container">
        <h1>Private Messages</h1>
        <!-- Clear All Messages Form -->
        <form method="post" action="clear_messages.php" class="clear-messages-form">
            <input type="hidden" name="userID" value="<?php echo $loggedInUserID; ?>">
            <button class="MESBUTTON" type="submit" onclick="return confirm('Are you sure you want to delete all your private messages? This action cannot be undone.');">Clear All Messages</button>
        </form>
    </div>
        ...
        if (!empty($privateMessages)) {
            ...
            foreach ($privateMessages as $privateMessage) {
                ...
                if (isset($message['UserID']) && $message['UserID'] == $loggedInUserID) {
                    echo " <a href='java_delete_mes.php?messageID={$message['MessageID']}' class='DelMes'>Delete</a>";
                }
