...
<body class="PythonBody">
    ...
    <div class="PythonChat">
        ...
        if (isset($message['UserID']) && $message['UserID'] == $loggedInUserID) {
            echo " <a href='python_edit_mes.php?messageID={$message['MessageID']}' class='EditMes'>Edit</a>";
            echo " <a href='python_delete_mes.php?messageID={$message['MessageID']}' class='DelMes'>Delete</a>";
        }
