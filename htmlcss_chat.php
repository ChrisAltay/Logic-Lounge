...
<body class="HtmlCssBody">
    ...
    <div class="HTMLCSSCHAT">
        ...
        if (isset($message['UserID']) && $message['UserID'] == $loggedInUserID) {
            echo " <a href='htmlcss_edit_mes.php?messageID={$message['MessageID']}' class='EditMes'>Edit</a>";
            echo " <a href='htmlcss_delete_mes.php?messageID={$message['MessageID']}' class='DelMes'>Delete</a>";
        }
